...
@section('content')
    ...
    <div class="flex lg:flex-row shadow bg-white">
        ...
        <div class="block lg:w-1/2">
            <img class="inset-0 h-full w-full object-cover-center" src="{{asset('img/4321.jpg')}}" alt="devjobs">
        </div>
    </div>
        ...
        <ul class="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
            @foreach($vacantes as $vacante)
               <li class="p-10 border border-gray-300 bg-white shadow">
                   <h2 class="text-2xl font-bold text-gray-700">{{$vacante->titulo}}</h2>
               
                    <p class="block text-gray-900 font-normal my-2">
