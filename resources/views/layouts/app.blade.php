...
<body class="bg-gray-200 min-h-screen leading-none">
    ...
    @if(session('estado'))
        <div class="bg-gray-500 p-8 text-center text-white font-bold uppercase">
            {{session('estado')}}
        </div>
    @endif
    ...
    <div id="app">
                    ...
                    <nav class="flex-1 text-right">
                            ...
                            <span class="text-gray-300 text-sm pr-4">{{Auth::user()->name }}</span> 
                                ...
                                <a 
                                    ...
                                    class="bg-gray-500 rounded-full mr-2 px-3 py-2 font-bold text-sm text-white"
        ...
        <div class="bg-gray-700">
            <nav class="container mx-auto flex flex-col text-center md:flex-row space-x-1 space-x-1">
                @yield('navegacion')
            </nav>
        </div>  
